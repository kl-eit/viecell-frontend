...
export default function AppointmentForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setSubmitMessage("✓ Appointment booked successfully! We'll contact you soon.");
        setFormData({
          name: "",
          email: "",
          phone: "",
    ...
    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-500 text-left">
      ...
      <div>
        <input
          ...
          onChange={handleChange}
          className={`border px-3.5 py-2.5  bg-white rounded-lg w-full focus:outline-none  ${
            errors.phone ? "border-red-500 focus:ring-red-300" : "border-gray-300"
          }`}
        />
      ...
      <div>
        <input
          ...
          onChange={handleChange}
          className={`border px-3.5 py-2.5  bg-white rounded-lg w-full focus:outline-none  ${
            errors.country ? "border-red-500 focus:ring-red-300" : "border-gray-300"
          }`}
        />
      ...
      <div>
        <label htmlFor="appointmentDate" className="block text-gray-600 text-sm mb-2">
          Appointment Date
        </label>
        <input
          id="appointmentDate"
          ...
          onChange={handleChange}
          className={`border px-3.5 py-2.5  bg-white rounded-lg w-full focus:outline-none  ${
            errors.appointmentDate ? "border-red-500 focus:ring-red-300" : "border-gray-300"
          }`}
        />
      ...
      <div>
        <input
          ...
          onChange={handleChange}
          className={`border px-3.5 py-2.5  bg-white rounded-lg w-full focus:outline-none  ${
            errors.timeSlot ? "border-red-500 focus:ring-red-300" : "border-gray-300"
          }`}
        />
      ...
      <div className="md:col-span-2">
        <textarea
          ...
          className={`border px-3.5 py-2.5  bg-white rounded-lg w-full h-32 resize-none focus:outline-none  ${
            errors.symptoms ? "border-red-500 focus:ring-red-300" : "border-gray-300"
          }`}
        />
      ...
      <div className="md:col-span-2">
        <label className="flex items-center gap-3 cursor-pointer">
          ...
          <span className="text-gray-600 text-sm">
            I agree to the <a href="#" className="text-lime-800 underline">Terms & Privacy Policy</a>
          </span>
        </label>
        {errors.agreeToTerms && <p className="text-red-500 text-sm mt-1">{errors.agreeToTerms}</p>}
      </div>
      {submitMessage && (
        <div className={`md:col-span-2 p-3 bg-white rounded-lg text-sm ${
