...
export default function Footer() {
  const footerData = [
    ...
    },
    {
      title: "Treatments",
      links: [
        { title: "Stem Cell Therapy", href: "#" },
        { title: "Regenerative Medicine", href: "#" },
        { title: "Eye Disorders", href: "#" },
        { title: "Infertility", href: "#" },
        { title: "Orthopedic Conditions", href: "#" },
        { title: "Neuro Disorders", href: "#" },
        { title: "Organ Related Treatments", href: "#" },
      ],
    },
    {
      title: "Media & Blog",
